...
pml_train_model <- pml_train_trabalho[,-c(1:7)]
inTrain<- createDataPartition(y= pml_train_model$classe, p=0.7, list = FALSE)
...
pml_test_model <- pml_test_trabalho[,-c(1:7,60)]


pred_test<- predict(model_treebag$finalModel,pml_test_model)
